...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    addArticle: function addArticle() {
      ...
      this.form.post('/article').then(function (r) {
        return _this.$emit('completed', r);
      });
    }
  },
...
/* harmony import */ var _components_AddArticle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/AddArticle */ "./resources/js/components/AddArticle.vue");
...
new Vue({
  el: '#app',
  components: {
    AddArticle: _components_AddArticle__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: {
    articles: []
  },
  methods: {
    pushNewArticle: function pushNewArticle(r) {
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('/dedicated-article').then(function (r) {
      return _this.articles = r.data;
    });
...
window.Editor = _tinymce_tinymce_vue__WEBPACK_IMPORTED_MODULE_4__["default"];
